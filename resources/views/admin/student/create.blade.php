...
<form action="{{ URL::to('/student/create') }}" method="POST" id="form_create_student" enctype="multipart/form-data">
							@csrf
										<div class="form-body">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="email" placeholder="enter email" class="form-control input-height" required="" />
												</div>
											</div>
											<div class="form-group row">
											...
											<div class="form-group row">
												...
												<div class="form-group row">
												<label class="control-label col-md-3">Select Your Semster
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
									<select class="form-control input-height" name="semster_id" required="">
														<option >select one </option>
														<option value="1">First Semster</option>
														<option value="2">Second Semster</option>
														<option value="3">Third Semster</option>
														<option value="4">Fourth Semster</option>
